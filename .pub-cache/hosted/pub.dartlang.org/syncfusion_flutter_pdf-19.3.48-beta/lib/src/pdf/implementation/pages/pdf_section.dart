...
class PdfSection implements _IPdfWrapper {
  ...
  void _remove(PdfPage page) {
    for (int i = 0; i < _pageReferences!._elements.length; i++) {
      final _IPdfPrimitive? pageReference = _pageReferences!._elements[i];
      if (pageReference != null &&
          pageReference is _PdfReferenceHolder &&
          pageReference.object == page._element) {
        _pageReferences!._elements.removeAt(i);
        _pages.remove(page);
        break;
      }
    }
