# 2.0.4
- _Hot Fix:_ Silently handle exceptions that occur within RPC request handlers.

# 2.0.3
- _Hot Fix:_ Fix another possibility of `LateInitializationError` being thrown when trying to
